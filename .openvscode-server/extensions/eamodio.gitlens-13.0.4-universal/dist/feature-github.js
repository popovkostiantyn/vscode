...
}`,x=await this.graphql(n,s,y,{...l,owner:i,repo:u,ref:a},p),N=(g=(d=x?.repository)==null?void 0:d.object)==null?void 0:g.author;return N==null?void 0:{provider:n,name:N.name??void 0,email:N.email??void 0,avatarUrl:!N.avatarUrl||Qe(l)?N.avatarUrl??void 0:N.email&&l?.baseUrl!=null?await this.createEnterpriseAvatarUrl(n,s,l.baseUrl,N.email,l.avatarSize):void 0}}catch(y){if(y instanceof b.Ww)return;throw this.handleException(y,n,p)}}async getAccountForEmail(n,s,i,u,a,l){var d,g;const p=(0,A.UH)();try{const y=`query getAccountForEmail(
	$emailQuery: String!
	$avatarSize: Int
) {
...
}`,x=await this.graphql(n,s,y,{...l,owner:i,repo:u,emailQuery:`in:email ${a}`},p),N=(g=(d=x?.search)==null?void 0:d.nodes)==null?void 0:g[0];return N==null?void 0:{provider:n,name:N.name??void 0,email:N.email??void 0,avatarUrl:!N.avatarUrl||Qe(l)?N.avatarUrl??void 0:N.email&&l?.baseUrl!=null?await this.createEnterpriseAvatarUrl(n,s,l.baseUrl,N.email,l.avatarSize):void 0}}catch(y){if(y instanceof b.Ww)return;throw this.handleException(y,n,p)}}async getDefaultBranch(n,s,i,u,a){var l,d;const g=(0,A.UH)();try{const p=`query getDefaultBranch(
	$owner: String!
	$repo: String!
) {
	repository(name: $repo, owner: $owner) {
...
}`,y=await this.graphql(n,s,p,{...a,owner:i,repo:u},g),x=((d=(l=y?.repository)==null?void 0:l.defaultBranchRef)==null?void 0:d.name)??void 0;return x==null?void 0:{provider:n,name:x}}catch(p){if(p instanceof b.Ww)return;throw this.handleException(p,n,g)}}async getIssueOrPullRequest(n,s,i,u,a,l){var d;const g=(0,A.UH)();try{const p=`query getIssueOrPullRequest(
	$owner: String!
	$repo: String!
	$number: Int!
) {
...
}`,y=await this.graphql(n,s,p,{...l,owner:i,repo:u,number:a},g),x=(d=y?.repository)==null?void 0:d.issueOrPullRequest;return x==null?void 0:{provider:n,type:x.type,id:String(a),date:new Date(x.createdAt),title:x.title,closed:x.closed,closedDate:x.closedAt==null?void 0:new Date(x.closedAt),url:x.url}}catch(p){if(p instanceof b.Ww)return;throw this.handleException(p,n,g)}}async getPullRequestForBranch(n,s,i,u,a,l){var d,g,p,y;const x=(0,A.UH)();try{const N=`query getPullRequestForBranch(
	$owner: String!
	$repo: String!
	$branch: String!
	$limit: Int!
...
}`,K=await this.graphql(n,s,N,{...l,owner:i,repo:u,branch:a,limit:10},x),O=(y=(p=(g=(d=K?.repository)==null?void 0:d.refs.nodes[0])==null?void 0:g.associatedPullRequests)==null?void 0:p.nodes)==null?void 0:y.filter(ee=>ee!=null&&(!ee.repository.isFork||ee.repository.owner.login===i));return O==null||O.length===0?void 0:(O.length>1&&O.sort((ee,ue)=>(ee.repository.owner.login===i?-1:1)-(ue.repository.owner.login===i?-1:1)||(ee.state==="OPEN"?-1:1)-(ue.state==="OPEN"?-1:1)||new Date(ue.updatedAt).getTime()-new Date(ee.updatedAt).getTime()),Me.GitHubPullRequest.from(O[0],n))}catch(N){if(N instanceof b.Ww)return;throw this.handleException(N,n,x)}}async getPullRequestForCommit(n,s,i,u,a,l){var d,g,p,y;const x=(0,A.UH)();try{const N=`query getPullRequestForCommit(
	$owner: String!
	$repo: String!
	$ref: GitObjectID!
	$avatarSize: Int
...
}`,K=await this.graphql(n,s,N,{...l,owner:i,repo:u,ref:a},x),O=(y=(p=(g=(d=K?.repository)==null?void 0:d.object)==null?void 0:g.associatedPullRequests)==null?void 0:p.nodes)==null?void 0:y.filter(ee=>ee!=null&&(!ee.repository.isFork||ee.repository.owner.login===i));return O==null||O.length===0?void 0:(O.length>1&&O.sort((ee,ue)=>(ee.repository.owner.login===i?-1:1)-(ue.repository.owner.login===i?-1:1)||(ee.state==="MERGED"?-1:1)-(ue.state==="MERGED"?-1:1)||new Date(ue.updatedAt).getTime()-new Date(ee.updatedAt).getTime()),Me.GitHubPullRequest.from(O[0],n))}catch(N){if(N instanceof b.Ww)return;throw this.handleException(N,n,x)}}async getBlame(n,s,i,u,a){var l,d,g,p,y;const x=(0,A.UH)();try{const N=`query getBlameRanges(
	$owner: String!
	$repo: String!
	$ref: String!
	$path: String!
...
}`,K=await this.graphql(void 0,n,N,{owner:s,repo:i,ref:u,path:a},x);if(K==null)return Je;const O=(g=(d=(l=K.repository)==null?void 0:l.object)==null?void 0:d.blame)==null?void 0:g.ranges;return O==null||O.length===0?{ranges:[],viewer:(p=K.viewer)==null?void 0:p.name}:{ranges:O,viewer:(y=K.viewer)==null?void 0:y.name}}catch(N){if(N instanceof b.Ww)return Je;throw this.handleException(N,void 0,x)}}async getBranches(n,s,i,u){var a;const l=(0,A.UH)();try{const d=`query getBranches(
	$owner: String!
	$repo: String!
	$branchQuery: String
	$cursor: String
...
}`,y=await this.graphql(void 0,n,p,{owner:s,repo:i,since:a.toISOString(),until:a.toISOString()},g),x=(d=(l=y?.repository)==null?void 0:l.refs)==null?void 0:d.nodes;if(x==null)return[];const N=[];for(const K of x)for(const O of K.target.history.nodes)if(O.oid===u){N.push(K.name);break}return N}catch(p){if(p instanceof b.Ww)return[];throw this.handleException(p,void 0,g)}}async getCommitCount(n,s,i,u){var a,l;const d=(0,A.UH)();try{const g=`query getCommitCount(
	$owner: String!
	$repo: String!
	$ref: String!
) {
...
}`,y=await this.graphql(void 0,n,p,{owner:s,repo:i,ref:`refs/heads/${u}`,since:l.toISOString(),until:l.toISOString()},g),x=(d=y?.repository)==null?void 0:d.ref.target.history.nodes;if(x==null)return[];const N=[];for(const K of x)if(K.oid===a){N.push(u);break}return N}catch(p){if(p instanceof b.Ww)return[];throw this.handleException(p,void 0,g)}}async getCommits(n,s,i,u,a){var l,d,g,p;const y=(0,A.UH)();if(a?.limit===1&&a?.path==null)return this.getCommitsCoreSingle(n,s,i,u);try{const x=`query getCommits(
	$owner: String!
	$repo: String!
	$ref: String!
	$path: String
...
}`;let N;if(a?.authors!=null)if(a.authors.length===1){const[ee]=a.authors;N={id:ee.id,emails:ee.email?[ee.email]:void 0}}else{const ee=a.authors.filter(ue=>ue.email).map(ue=>ue.email);N=ee.length?{emails:ee}:void 0}const K=await this.graphql(void 0,n,x,{owner:s,repo:i,ref:u,after:a?.after,before:a?.before,path:a?.path,author:N,limit:Math.min(100,a?.limit??100),since:typeof a?.since=="string"?a?.since:(l=a?.since)==null?void 0:l.toISOString(),until:typeof a?.until=="string"?a?.until:(d=a?.until)==null?void 0:d.toISOString()},y),O=(p=(g=K?.repository)==null?void 0:g.object)==null?void 0:p.history;return O==null?Ce:{paging:O.pageInfo.endCursor!=null?{cursor:O.pageInfo.endCursor??void 0,more:O.pageInfo.hasNextPage}:void 0,values:O.nodes,viewer:K?.viewer.name}}catch(x){if(x instanceof b.Ww)return Ce;throw this.handleException(x,void 0,y)}}async getCommitsCoreSingle(n,s,i,u){var a;const l=(0,A.UH)();try{const d=`query getCommit(
	$owner: String!
	$repo: String!
	$ref: String!
) {
...
}`,y=await this.graphql(void 0,n,p,{owner:s,repo:i,ref:u,path:a?.path,first:a?.first,last:a?.last,after:a?.after,before:a?.before,since:a?.since,until:a?.until},g),x=(d=(l=y?.repository)==null?void 0:l.object)==null?void 0:d.history;return x==null?void 0:{pageInfo:x.pageInfo,totalCount:x.totalCount,values:x.nodes}}catch(p){if(p instanceof b.Ww)return;throw this.handleException(p,void 0,g)}}async getNextCommitRefs(n,s,i,u,a,l){const d=await this.getCommitDate(n,s,i,l);if(d==null)return[];let g=await this.getCommitRefs(n,s,i,u,{path:a,first:1,since:d});if(g==null)return[];const p=`${g.pageInfo.startCursor.split(" ",1)[0]} ${g.totalCount}`;let y;if([,y]=p.split(" ",2),y=Math.min(parseInt(y,10),5),g=await this.getCommitRefs(n,s,i,u,{path:a,last:y,before:p}),g==null)return[];const x=[];for(const{oid:N}of g.values){if(N===l)break;x.push(N)}return x.reverse()}async getCommitDate(n,s,i,u){var a,l;const d=(0,A.UH)();try{const g=`query getCommitDate(
	$owner: String!
	$repo: String!
	$sha: GitObjectID!
) {
